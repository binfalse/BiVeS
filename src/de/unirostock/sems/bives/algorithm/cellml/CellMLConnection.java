...
public class CellMLConnection
{
	public static final void parseConnection (CellMLModel model, CellMLHierarchy hierarchy, DocumentNode connection) throws CellMLReadException, BivesConsistencyException, BivesLogicalException
	{
		...
		for (TreeNode kid : kids)
		{
			...
			CellMLVariable variable_2 = component_1.getVariable (v2);
			...
			switch (relation)
			{
				case CellMLHierarchy.RELATION_PARENT:
					...
					throw new BivesLogicalException ("cannot connect variables due to logical restrictions. (components: "+component_1.getName ()+","+component_2.getName ()+", variables: "+variable_1.getName ()+","+variable_2.getName ()+")");
